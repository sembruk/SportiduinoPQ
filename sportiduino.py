...
class Sportiduino(object):
    ...
    def card_name(card_type):
        card_type_to_str = [
            "Not detected",
            Sportiduino._translate("sportiduino", "Compliant with ISO/IEC 14443-4"),
            Sportiduino._translate("sportiduino", "Compliant with ISO/IEC 18092 (NFC)"),
            "MIFARE Classic Mini",
            "MIFARE Classic 1K",
            "MIFARE Classic 4K",
            "MIFARE Ultralight",
